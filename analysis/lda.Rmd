...
Como conclusão, percebemos que os modelos que não consideram o atributo *free sulfur dioxide* são os mais vantajosos em ambos os data sets. Sendo que no data set de vinho tinto produz resultado significativamente melhores.
