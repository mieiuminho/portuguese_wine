...
```{r fig.cap="Visualização da relação entre os tipos de acidez"}
...
```{r fig.cap="Representatividade dos Cloretos por tipo de Qualidade"}
par(mfrow=c(1,2))
...
```{r fig.cap="Visualização da relação entre os tipos de dióxido de enxofre"}
...
```{r fig.cap="Visualização da relação entre os tipos de dióxido de enxofre com regressão linear"}
plot(red_wine$free.sulfur.dioxide, red_wine$total.sulfur.dioxide, xlab="Dióxido de Enxofre Livre", ylab="Dióxido de Enxofre Total")
...
```{r fig.cap="Visualização da relação entre a raiz quadrada dos tipos de dióxido de enxofre com regressão linear"}
...
```{r hist-quality, fig.cap="Distribuição da Qualidade entre vinhos"}
par(mfrow=c(1,2))
...
```{r fig.cap="Visualização da relação entre os vários atributos"}
